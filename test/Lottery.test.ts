...
describe("Lottery contract", function () {
  ...
  it(" Should init lottery with default numHours = 0", async function () {
  ...
  describe("1)Deployment", function () {
    ...
    it(" Should initialize a new lottery from owner", async function () {
      const numHours = 7 * 24;
    ...
    describe("After first lottery initialized", function () {
      ...
      it(" should cancel lottery", async function () {
      ...
      describe("After player1 mints tickets", function () {
        ...
        it(" Find winning address with only 1 player", async function () {
